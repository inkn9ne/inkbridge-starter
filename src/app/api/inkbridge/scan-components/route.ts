...
// When started with `inkbridge:dev:local` (INKBRIDGE_LOCAL=1), use the sibling
// repo's scanner source directly so scanner changes are picked up without
// reinstalling.
const CLI = process.env.INKBRIDGE_LOCAL
  ? path.resolve(CWD, '../inkbridge/tools/figma-plugin/scanner/cli.ts')
