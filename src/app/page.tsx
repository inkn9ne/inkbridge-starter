            ...
            {[
              {
                ...
                description: <>Run <code className="rounded bg-muted px-1 py-0.5 text-xs font-mono">pnpm dev</code> in your terminal. This starts the Next.js server that the plugin uses to scan components and patch tokens.</>,
              },
              {
